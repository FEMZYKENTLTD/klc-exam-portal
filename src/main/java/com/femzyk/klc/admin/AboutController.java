    ...
    public void initialize() {
        ...
        if (crisisLabel != null) {
            crisisLabel.setText(
                ...
                "- Student records lost when files go missing or students transfer schools.\n" +
                "- WAEC / NECO preparation is guesswork with no real data on weak topics.\n\n" +
                "THE NUMBERS (2024):\n" +
                "Only 68% of WAEC candidates earned credits in 5+ subjects including Maths & English — " +
                "nearly 1 in 3 fell short. Schools using CBT report up to 40% fewer malpractice incidents " +
                "and 3x faster result processing."
            );
        }
        ...
        if (metricsLabel != null) {
            metricsLabel.setText(
                ...
                "* 10+ YEARS STUDENT RECORD ARCHIVE — Permanent cumulative transcript & CGPA tracking.\n" +
        ...
        if (stepsLabel != null) {
            stepsLabel.setText(
                ...
                "1. INSTALL & CONFIGURE: Deploy JavaFX app in labs & web portal. Works offline on Windows 7-11.\n" +
                "2. ONBOARD STAFF & STUDENTS: Register teachers, assign classes, import student CSV records.\n" +
                "3. UPLOAD QUESTIONS & GO LIVE: Upload past WAEC/NECO questions, set proctoring rules, and run!"
            );
        }
